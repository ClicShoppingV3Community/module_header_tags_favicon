 ...
 */
  ...
  class ht_favicon {
    ...
    public function execute() {
      ...
      $CLICSHOPPING_Template->addBlock('<link rel="icon" type="image/' . $extension_favicon . '" href="'. HTTP::getShopUrlDomain() . 'sources/imagesicons/favicon.' . $extension_favicon . '">', $this->group);
    }
